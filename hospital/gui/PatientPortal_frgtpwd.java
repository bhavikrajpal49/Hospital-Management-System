 ...
 * @author Hp
 */
public class PatientPortal_frgtpwd extends javax.swing.JFrame {
    Connection con;
    ...
    /**
     * Creates new form PatientPortal_frgtpwd
     */
    public PatientPortal_frgtpwd() {
        initComponents();
    }
    ...
    private void ViewbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewbtnActionPerformed
        ...
        try
        {
            ...
            while(rs.next())
            {
                String uname = rs.getString("pat_username");
                String answer = rs.getString("pat_answer");
                String password = rs.getString("pat_password");
    ...
    private void verifybtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verifybtnActionPerformed
        ...
        try
        {
            con = DBconnection.getConnection();
            st = con.createStatement();
            rs = st.executeQuery("select pat_question from patient1 where pat_username = '"+id+"' ");
            if(rs.next())
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientPortal_frgtpwd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientPortal_frgtpwd().setVisible(true);
            }
        });
    }
