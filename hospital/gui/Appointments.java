...
public class Appointments extends javax.swing.JFrame {
    ...
    public Appointments(String pid) {
        initComponents();
        patient = pid;
        viewapt();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Scheduled Appointments");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 460, 50));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 0, 60, 60));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 1450, 60));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1650, 110, 50, 50));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/appt_icon.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 110, 110));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        PatientPortal pp = new PatientPortal(patient);
        pp.show();
        ...
        try
            {
                ...
                pst =con.prepareStatement("select * from appointment where appt_patid=?");
